...
const CategoryModal = ({ isOpen, mode, category, onClose, onSave,handleEdit, handleCreate }) => {
          ...
          <form>
            ...
            <div className='mb-4'>
              ...
              <input
                ...
                readOnly={mode === 'show'}
                onChange={(e) =>
                  onSave({ ...category, name: e.target.value })
                }
            ...
            <div className='mb-4'>
              ...
              <textarea
                ...
                readOnly={mode === 'show'}
                onChange={(e) =>
                  onSave({ ...category, description: e.target.value })
                }
                className='w-full p-2 border rounded'
              />
            </div>
            <div className='flex justify-end space-x-4'>
              ...
              {mode !== 'show' && (
                <button
                    onClick={()=>mode=== 'edit' ? handleEdit(category.idCategory, category): handleCreate(category) }
                  type='submit'
